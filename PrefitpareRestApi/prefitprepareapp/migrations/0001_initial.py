    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kcalPorGramo', models.DecimalField(decimal_places=2, max_digits=5)),
                ('origenPais', models.CharField(max_length=40)),
                ('categoria', models.ManyToManyField(to='prefitprepareapp.categoria')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ImagenPerfil', models.URLField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('origenPais', models.CharField(max_length=40)),
                ('categoria', models.ManyToManyField(to='prefitprepareapp.categoria')),
                ('ingrediente', models.ManyToManyField(to='prefitprepareapp.ingrediente')),
                ('personaTipo', models.ManyToManyField(to='prefitprepareapp.personatipo')),
            ],
            options={
                'abstract': False,
            },
