...
class SerializadorTipoPersona(SerializadorBase):
    """
    Serializador que extiende SerializadorBase y proporciona la referencia al modelo TipoPersona,
    ...
    def modificar(self, id, **kwargs):
        ...
        Parámetros:
            **kwargs: Diccionario descomprimido con los campos para modificar la instancia.
            id (int): Identificador del objeto TipoPersona a  modificar.
    ...
    def eliminar(self, id):
        ...
        Parámetros:
            id (int): Identificador del objeto TipoPersona a eliminar.
        """
